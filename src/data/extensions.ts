    ...
    extensions: [
      {
        ...
        icon: "/ext-icons/shorts-killer.png",
      },
      {
        name: "X Detox",
    ...
    extensions: [
      {
        ...
        icon: "/ext-icons/yahoo-kaiteki-mode.png",
      },
      {
        name: "物件スカウター（賃貸版）",
        ...
        icon: "/ext-icons/bukken-scouter-rental.png",
      },
      {
        name: "PromptStash",
        ...
        icon: "/ext-icons/promptstash.png",
      },
      {
        ...
        icon: "/ext-icons/japanese-font-finder.png",
      },
      {
        name: "DataPick",
    ...
    extensions: [
      {
        ...
        icon: "/ext-icons/rakuten-sellers-analytics.png",
      },
      {
        name: "Arbitra",
    ...
    extensions: [
      {
        ...
        icon: "/ext-icons/bukken-scouter-purchase.png",
      },
    ],
  },
];
